...
"""
Modifications (Daniel Nzekwe):
    - added __future__ import annotations to let the script work on my Python 3.12
    - added datetime from datetime to make time-stamping work in PageParser.handle_endtag()
"""
